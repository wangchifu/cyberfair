...
define('REDIR_URI0', 'https://cyberfair.chc.edu.tw/auth/callback');
    ...
    public function callback(Request $request){
      ...
      $user_obj['email'] = $userinfo['sub']."@openID";
        ...
        if ($user_obj['success']) {
            ...
            $user_att['code'] = $user_obj['code'];
            $user_att['school'] = $user_obj['school']; 
            $user_att['name'] = $user_obj['name'];
            $user_att['email'] = $user_obj['email'];
            $user_att['username'] = $user_obj['username'];
            $user_att['password'] = $user_obj['password'];
            $user_att['kind'] = $user_obj['kind'];
            $user_att['title'] = $user_obj['title'];
